...
export const ClientNameProperty = styled.span`
  margin: 0;
  font-size: 15px;
  font-weight: bold;
  color: #f58732;
...
export const NameProperty = styled.p`
  margin: 0;
  margin-right: 30px;
  font-weight: bold;
  font-size: 30px;
...
export const ContainerOutletPropertyDetails = styled.div`
  width: 100%;
  height: 670px;
  display: flex;
  flex-direction: column;
...
export const InfoBlockAdress = styled.div`
  width: 100%;
`
